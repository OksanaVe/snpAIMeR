# Edit line 29 with file information (do not change "file,")
# For default settings, execute function as SNP_check(<file name>), with file name in quotes

SNP_check <- function(file, min_loc_num=1, max_loc_num=2, rate_threshold=.9) {
	...
	ludens <- read.structure(file, n.ind=176, n.loc=15, onerowperind=FALSE, col.lab=1, col.pop=2, row.marknames=1, ask=FALSE)
